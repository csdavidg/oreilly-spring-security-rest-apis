...
public class GoalInitializer implements SmartInitializingSingleton {
	...
	public void afterSingletonsInstantiated() {
		...
		User user = new User("user", "$2a$10$3njzOWhsz20aimcpMamJhOnX9Pb4Nk3toq8OO0swIy5EPZnb1YyGe");
		...
		User hasRead = new User("hasread", "$2a$10$3njzOWhsz20aimcpMamJhOnX9Pb4Nk3toq8OO0swIy5EPZnb1YyGe");
		hasRead.setFullName("Has Read");
		hasRead.grantAuthority("goal:read");
		hasRead.grantAuthority(("user:read"));
		this.users.save(hasRead);

		User hasWrite = new User("haswrite", "$2a$10$3njzOWhsz20aimcpMamJhOnX9Pb4Nk3toq8OO0swIy5EPZnb1YyGe");
		...
		User admin = new User("admin", "$2a$10$3njzOWhsz20aimcpMamJhOnX9Pb4Nk3toq8OO0swIy5EPZnb1YyGe");
